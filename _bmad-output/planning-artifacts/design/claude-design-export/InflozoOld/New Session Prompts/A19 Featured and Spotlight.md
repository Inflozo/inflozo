# Inflozo — Design Prompt 3: A19 Featured and Spotlight
...
|---|---|---|---|
| A19 | Featured and Spotlight | 15 | Binds live Ghost data; the spec must state what happens with 0, 1 and many items. |
...
## 8. What A19 must settle

1. What 'featured' reads from in Ghost, and what happens when nothing is marked.
2. One spotlight versus three, and the hierarchy between them.
3. A featured post with no image, which is the common case.
4. 0, 1 and many, and whether the section hides itself at 0.
