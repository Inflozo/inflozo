# Inflozo — Design Prompt 3: A11 Logo Walls
...
## 8. What A11 must settle

1. Logo counts and row wrapping, including the awkward final row.
2. Mixed aspect ratios and how heights are normalised without distortion.
3. Greyscale, muted and full-colour treatments, checked in light and dark.
4. Whether logos are links, and whether the wall carries a caption.
