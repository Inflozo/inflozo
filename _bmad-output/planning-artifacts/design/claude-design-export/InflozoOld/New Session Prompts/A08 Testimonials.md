# Inflozo — Design Prompt 3: A8 Testimonials
...
## 8. What A8 must settle

1. Quote length range, and what a 300-character quote does to a card.
2. Attribution with and without an avatar, and with an organisation line.
3. Single, grid and slider arrangements — and whether the slider is allowed at all under reduced-motion.
4. Whether quotes are authored or pulled from Ghost, and the 0 / 1 / many rule if pulled.
