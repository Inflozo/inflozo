# Inflozo — Design Prompt 3: A24 Post Headers
...
## 8. What A24 must settle

1. Title measure and a 90-character title at every width.
2. The meta row's composition, reusing A1's avatar and meta row.
3. Feature image placements — above, below, full-bleed, none — and the interaction with A1·4 Overlay.
4. The series or tag eyebrow, and what shows when a post has no tags.
