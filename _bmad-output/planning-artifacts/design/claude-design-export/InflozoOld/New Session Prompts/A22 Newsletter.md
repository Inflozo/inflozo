# Inflozo — Design Prompt 3: A22 Newsletter / Subscribe
...
|---|---|---|---|
| A22 | Newsletter / Subscribe | 16 | Binds live Ghost data; the spec must state what happens with 0, 1 and many items. |
...
## 8. What A22 must settle

1. The form's four states — empty, invalid, submitting, done — in every arrangement.
2. The Ghost members handoff, and what happens when members are disabled.
3. Sites with more than one newsletter, and how the reader chooses.
4. What an already-subscribed signed-in member sees instead of the form.
