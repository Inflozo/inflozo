# Inflozo — Design Prompt 3: A12 About and Team
...
## 8. What A12 must settle

1. Person card with and without a photo, and the initials fallback from A1·14.
2. Role and bio length limits, and a team member with neither.
3. Teams of 1, 4 and 12, and the last-row problem.
4. Per-person links, and where they go when Ghost has no author page.
