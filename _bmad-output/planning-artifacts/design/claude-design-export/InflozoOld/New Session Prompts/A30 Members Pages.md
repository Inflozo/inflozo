# Inflozo — Design Prompt 3: A30 Members Pages
...
## 8. What A30 must settle

1. Which pages are themeable and which are Portal's — state the boundary on every frame.
2. Signup and sign-in form states, including magic-link sent and link expired.
3. The account page as display-only: what it shows for free, paid and comped members.
4. Confirm the A1·14 assumption that tier and renewal date are readable.
