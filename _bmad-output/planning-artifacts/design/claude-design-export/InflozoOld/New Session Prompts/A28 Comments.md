# Inflozo — Design Prompt 3: A28 Comments
...
## 8. What A28 must settle

1. The frame only: heading, count, rules line, and the block Ghost injects.
2. Signed-out, free-member and paid-only states, and the prompt in each.
3. Where the block sits relative to A26 Post Footers.
4. What the design must not style, because Ghost owns it.
