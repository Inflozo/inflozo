# Inflozo — Design Prompt 3: A15 Video and Embeds
...
## 8. What A15 must settle

1. Poster frame versus autoplay-muted, and what plays on a phone.
2. Holding the aspect ratio while the embed loads, so nothing jumps.
3. A consent or click-to-load placeholder for third-party embeds.
4. Caption, credit and transcript link, and where a transcript lives.
