# Inflozo — Design Prompt 3: A29 Archive Headers
...
## 8. What A29 must settle

1. Tag, author and date archives from one design.
2. Description and post count, and an archive with neither.
3. A tag with a feature image versus one without.
4. The 0-posts archive, which is reachable and must not look broken.
