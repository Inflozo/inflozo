# Inflozo — Design Prompt 3: A14 Galleries
...
## 8. What A14 must settle

1. Grid, masonry and carousel arrangements, and which survive reduced-motion.
2. Mixed aspect ratios, and whether crops are enforced.
3. Captions: per image, per gallery, or none.
4. Lightbox behaviour — focus trap, Escape, arrow keys, and the caption inside it.
