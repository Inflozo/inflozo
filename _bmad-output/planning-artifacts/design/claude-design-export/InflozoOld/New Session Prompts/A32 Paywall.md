# Inflozo — Design Prompt 3: A32 Paywall / Content CTA
...
## 8. What A32 must settle

1. The cut itself: blur and fade over the visible preview only, never over withheld text.
2. Free-signup gate versus paid-upgrade gate, and the copy for each.
3. The Portal handoff, and what a signed-in free member sees.
4. How the section reads directly after a paragraph, a heading, and an image.
