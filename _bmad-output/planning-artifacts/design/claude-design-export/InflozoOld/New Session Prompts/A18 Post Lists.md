# Inflozo — Design Prompt 3: A18 Post Lists
...
|---|---|---|---|
| A18 | Post Lists | 15 | Binds live Ghost data; the spec must state what happens with 0, 1 and many items. |
...
## 8. What A18 must settle

1. Row density and separators, and the smallest row that still reads.
2. Thumbnail on, off, or on the leading edge.
3. Grouping by date, tag or nothing, and where the group heading sits.
4. 0, 1 and many, including a list with one item and a group heading.
