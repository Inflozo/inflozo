# Inflozo — Design Prompt 3: A27 Related Posts
...
|---|---|---|---|
| A27 | Related Posts | 12 | Binds live Ghost data; the spec must state what happens with 0, 1 and many items. |
...
## 8. What A27 must settle

1. How relatedness is chosen — tag, author, recency — and what the spec promises.
2. Counts of 2, 3 and 4, and fewer related posts than slots.
3. Reusing A17's post card rather than inventing a new one.
4. 0 related posts: hide the section, or fall back to recent.
