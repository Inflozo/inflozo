# Inflozo — Design Prompt 3: A10 Stats and Numbers
...
## 8. What A10 must settle

1. Counts of 2, 3 and 4, and the rule for 5.
2. Units, prefixes and suffixes, and how a stat with no unit reads.
3. The source or footnote line, and whether it is per stat or per section.
4. A stat with no label, and a label of 60 characters.
