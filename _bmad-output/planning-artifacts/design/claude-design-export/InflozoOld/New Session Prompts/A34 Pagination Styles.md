# Inflozo — Design Prompt 3: A34 Pagination Styles
...
## 8. What A34 must settle

1. Numbered pages, load-more and infinite scroll, and which are honest about position.
2. First, last, current and disabled states, and a two-page feed.
3. How it attaches beneath A17 and A18 without inventing new spacing.
4. Announcing newly loaded items to assistive technology.
