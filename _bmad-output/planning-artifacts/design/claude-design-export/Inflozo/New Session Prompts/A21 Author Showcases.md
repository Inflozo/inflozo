# Inflozo — Design Prompt 3: A21 Author Showcases
...
|---|---|---|---|
| A21 | Author Showcases | 15 | Binds live Ghost data; the spec must state what happens with 0, 1 and many items. |
...
## 8. What A21 must settle

1. The author card: avatar, bio, post count, social — reusing A1·14's avatar.
2. A single-author site, which is most sites, versus a masthead of twelve.
3. Authors with no bio and no picture.
4. 0, 1 and many, and the link to each author archive (A29).
