# Inflozo — Design Prompt 3: A7 Pricing and Tiers
...
## 8. What A7 must settle

1. Tier counts of 1, 2 and 3, and the monthly / yearly switch as a control or as content.
2. How the recommended tier is marked without a second accent.
3. The Ghost Portal handoff for checkout, and what the button says before it.
4. A site with one paid tier, and a site with none — the section must still render.
