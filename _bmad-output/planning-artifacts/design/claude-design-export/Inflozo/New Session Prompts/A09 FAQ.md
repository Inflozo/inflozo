# Inflozo — Design Prompt 3: A9 FAQ
...
## 8. What A9 must settle

1. Accordion versus always-open, and whether more than one row can be open.
2. Deep-linking a single question, and what that does to the closed rows.
3. Answers containing lists, links and code, at the section's measure.
4. Two columns of questions and how they reorder at 390.
