# Inflozo — Design Prompt 3: A16 Contact
...
## 8. What A16 must settle

1. Field sets, and which fields are ever required.
2. Validation, submitting, success and error states for every arrangement.
3. Whether Ghost can receive the submission at all, and what the fallback is.
4. Address, hours or map block beside the form, and how it stacks at 390.
