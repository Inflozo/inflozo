# Inflozo — Design Prompt 3: A20 Tag Collections
...
|---|---|---|---|
| A20 | Tag Collections | 15 | Binds live Ghost data; the spec must state what happens with 0, 1 and many items. |
...
## 8. What A20 must settle

1. The tag card: name, count, description, image — and which are optional.
2. Tags with no posts, and whether they render.
3. Long tag names and internal tags, which must never appear.
4. 0, 1 and many, and the link to each tag archive (A29).
