# Inflozo — Design Prompt 3: A26 Post Footers
...
## 8. What A26 must settle

1. The author bio block, and a post with two authors.
2. Tag row, share row and next/prev, and their order.
3. The newsletter CTA here versus A22 — one of them has to yield.
4. A post with no tags, no next post, and no author bio.
