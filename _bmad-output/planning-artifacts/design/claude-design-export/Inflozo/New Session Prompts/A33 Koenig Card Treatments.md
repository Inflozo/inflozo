# Inflozo — Design Prompt 3: A33 Koenig Card Treatments
...
## 8. What A33 must settle

1. Every Koenig card Ghost can render: image, gallery, bookmark, callout, toggle, button, embed, product, file, header.
2. Captions, credits and dark mode for each.
3. The relationship to the card design module in Prompt 2 Part C — same surface, one vocabulary.
4. What is a treatment versus what belongs in A25's measure.
