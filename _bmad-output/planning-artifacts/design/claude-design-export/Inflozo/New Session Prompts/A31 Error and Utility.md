# Inflozo — Design Prompt 3: A31 Error and Utility
...
|---|---|---|---|
| A31 | Error and Utility | 10 | 404, 500, private-site gate. |
...
## 8. What A31 must settle

1. 404, 500 and the private-site gate, and what navigation each keeps.
2. The gate's form states — empty, wrong password, submitting.
3. Whether search appears on a 404, and what it searches.
4. What a 500 can rely on rendering at all.
