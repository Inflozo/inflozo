# Inflozo — Design Prompt 3: A5 Features
...
## 8. What A5 must settle

1. Grid counts of 2, 3 and 4, and what happens at 5 and 7 items.
2. Media per item: icon, image or nothing — and whether a pack supplies icons at all.
3. Whether a feature item is a link, and what its hover state is if so.
4. An item with a title and no body copy, and one with 90 characters of title.
