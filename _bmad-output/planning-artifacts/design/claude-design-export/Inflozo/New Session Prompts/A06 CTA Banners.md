# Inflozo — Design Prompt 3: A6 CTA Banners
...
## 8. What A6 must settle

1. Contrast band versus surface card versus full-bleed image, and the accent budget in each.
2. One action or two, and what the secondary action is allowed to be.
3. How a banner reads immediately above the footer, which is where most will sit.
4. Inline form versus link-out, and the handoff to Ghost Portal when it is a signup.
