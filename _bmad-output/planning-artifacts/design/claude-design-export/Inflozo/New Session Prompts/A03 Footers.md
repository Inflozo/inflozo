# Inflozo — Design Prompt 3: A3 Footers
...
## 8. What A3 must settle

1. Link columns: how many, what happens with 2 or 7, and how they stack at 390.
2. The newsletter inline form and its four states — empty, invalid, submitting, done — and how it avoids duplicating A22.
3. The social row when Ghost has no social fields set.
4. The legal line, copyright and Ghost's attribution, and whether a site may remove it.
