# Inflozo — Design Prompt 3: A17 Post Grids
...
|---|---|---|---|
| A17 | Post Grids | 18 | Binds live Ghost data; the spec must state what happens with 0, 1 and many items. |
...
## 8. What A17 must settle

1. 0, 1 and many posts, for every design in the category.
2. The card's field set — image, tag, excerpt, author, date, reading time — and which are optional.
3. The feature-post treatment, and what happens when nothing is featured.
4. Where pagination attaches, and the handoff to A34.
