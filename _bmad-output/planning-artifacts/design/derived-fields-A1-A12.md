...
- Archetype: nav
- Tuple: nav · horizontal · few · none · hairline rule
...
- Archetype: nav
- Tuple: nav · horizontal · many · none · centred wordmark
...
- Archetype: stack
- Tuple: stack · vertical · many · none · display masthead
...
- Archetype: overlay
- Tuple: overlay · layered · few · background · transparent over image
...
- Archetype: nav
- Tuple: nav · horizontal · few · none · floating pill
...
- Archetype: overlay
- Tuple: overlay · layered · variable · none · display-size takeover
...
- Archetype: nav
- Tuple: nav · horizontal · few · none · full-width mega panel
...
- Archetype: stack
- Tuple: stack · vertical · many · none · utility strip
...
- Archetype: nav
- Tuple: nav · horizontal · few · none · persistent search field
...
- Archetype: nav
- Tuple: nav · horizontal · few · none · contrast band
...
- Archetype: edge rail
- Tuple: edge rail · vertical · many · none · leading accent bar
...
- Archetype: nav
- Tuple: nav · horizontal · few · none · content-aligned hairline box
...
- Archetype: nav
- Tuple: nav · horizontal · few · none · centred nav
...
- Archetype: nav
- Tuple: nav · horizontal · few · none · bare icon cluster
...
- Archetype: stack
- Tuple: stack · horizontal · few · none · oversized wordmark
...
- Archetype: sticky
- Tuple: sticky · horizontal · few · none · upward-scroll return
...
- Archetype: bar
- Tuple: bar · horizontal · none · none · contrast band
...
- Archetype: split
- Tuple: split · horizontal · none · none · single accent button
...
- Archetype: bar
- Tuple: bar · horizontal · none · none · accent label pill
...
- Archetype: stack
- Tuple: stack · vertical · none · none · display headline
...
- Archetype: form
- Tuple: form · horizontal · none · none · inline email field
...
- Archetype: bar
- Tuple: bar · horizontal · none · none · live clock
...
- Archetype: split
- Tuple: split · horizontal · none · none · publication meta slot
- No-JS: Renders as drawn and always shows; the close is inert without script (no collapse, no dismiss memory).
...
- Archetype: carousel
- Tuple: carousel · horizontal · variable · none · ticker marquee
...
- Archetype: carousel
- Tuple: carousel · horizontal · variable · none · timed rotation
...
- Archetype: bar
- Tuple: bar · horizontal · none · none · surrounding air
...
- Archetype: overlay
- Tuple: overlay · layered · none · none · late-arriving corner card
...
- Tuple: media frame · horizontal · none · left · bled image panel
...
- Archetype: overlay
- Tuple: overlay · layered · none · none · equal-weight answer pair
...
- Archetype: edge rail
- Tuple: edge rail · horizontal · none · none · collapsed accent rule
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · none · hairline dividers
...
- Archetype: bar
- Tuple: bar · horizontal · few · none · single hairline row
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · none · brand-anchored link columns
...
- Archetype: grid-of-N
- Tuple: grid-of-N · vertical · variable · none · paired ground tiers
...
- Archetype: form
- Tuple: form · horizontal · one · none · accent subscribe button
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · none · full contrast ground
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · centred fixed measure
...
- Archetype: stack
- Tuple: stack · vertical · one · none · oversized wordmark
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · many · none · maximum column density
...
- Archetype: feed
- Tuple: feed · horizontal · few · inline · self-updating post feed
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · none · labelled contact block
...
- Tuple: article body · vertical · variable · none · reading-measure prose
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · none · inset card panel
...
- Archetype: nav
- Tuple: nav · horizontal · many · none · uniform tag chips
...
- Archetype: media frame
- Tuple: media frame · layered · one · full-bleed · bottom-up scrim
...
- Archetype: nav
- Tuple: nav · horizontal · variable · none · reading-size link wrap
...
- Archetype: sticky
- Tuple: sticky · horizontal · few · none · pin-and-release bar
...
- Archetype: stack
- Tuple: stack · vertical · none · none · centred narrow measure
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · empty right half
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: stack
- Tuple: stack · vertical · none · none · nameplate over rule
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: overlay
- Tuple: overlay · layered · none · background · labelled play control
...
- Archetype: form
- Tuple: form · vertical · none · none · one-row email form
...
- Archetype: split
- Tuple: split · horizontal · none · edge · edge-bleed picture
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: split
- Tuple: split · horizontal · one · right · live post card
...
- Archetype: overlay
- Tuple: overlay · layered · none · background · full-window height
...
- Archetype: form
- Tuple: form · vertical · none · none · single search field
...
- Archetype: stack
- Tuple: stack · vertical · none · inline · display quotation
...
- Archetype: bar
- Tuple: bar · horizontal · none · none · one-row page title
...
- Archetype: overlay
- Tuple: overlay · layered · none · top · overlapping surface card
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · three bare columns
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · left · two capped-measure columns
- No-JS: No behaviour — renders as drawn without JS.

### A5-3 Four Up
- Descriptor: Four items across 300 px each — the densest grid the ladder allows, the design for eight or more.
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · four dense columns
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · card grid
...
- Archetype: split
- Tuple: split · horizontal · variable · none · head column beside grid
...
- Archetype: stack
- Tuple: stack · vertical · variable · left · full-width ruled rows
...
- Archetype: split
- Tuple: split · vertical · few · left · alternating picture sides
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · picture-topped card grid
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · inline · double-span first tile
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · contrast band
...
- Archetype: grid-of-N
- Tuple: grid-of-N · vertical · variable · none · mark per entry
...
- Archetype: nav
- Tuple: nav · layered · variable · right · tabbed panels
...
- Archetype: split
- Tuple: split · horizontal · variable · left · spotlit first item
...
- Archetype: edge rail
- Tuple: edge rail · horizontal · many · top · right-bleeding card rail
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · index numerals
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · hairline-divided panel
...
- Archetype: form
- Tuple: form · vertical · none · none · one-row form
...
- Archetype: overlay
- Tuple: overlay · layered · none · background · flat scrim wash
...
- Archetype: split
- Tuple: split · horizontal · none · right · unscrimmed picture half
...
- Archetype: bar
- Tuple: bar · horizontal · none · none · hairline rules
...
- Archetype: split
- Tuple: split · horizontal · variable · none · marked reason list
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · none · twin accent asks
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: stack
- Tuple: stack · vertical · none · none · footer-crossing card
...
- Archetype: stack
- Tuple: stack · vertical · none · none · member-state ask
...
- Archetype: stack
- Tuple: stack · vertical · none · left · signature block
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · none · highlighted tier
...
- Archetype: table
- Tuple: table · vertical · variable · none · comparison table
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · fixed-column rows
...
- Archetype: split
- Tuple: split · horizontal · variable · none · left-margin head
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · none · contrast band
...
- Archetype: split
- Tuple: split · horizontal · one · none · single centred card
...
- Archetype: split
- Tuple: split · horizontal · few · none · enlarged recommended tier
- No-JS: NEEDS DESIGN ANSWER: cadence switch (Billing period Both) — §0 never names which cadence is the rendered resting state, so the static prices without JS cannot be derived. At Monthly or Yearly the design has no behaviour and renders as drawn.
...
- Archetype: bar
- Tuple: bar · horizontal · variable · none · slim row
...
- Archetype: stack
- Tuple: stack · vertical · one · none · oversized price
...
- Archetype: nav
- Tuple: nav · layered · few · none · tab-switched panel
...
- Archetype: split
- Tuple: split · horizontal · few · none · paid-only plane
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · right-aligned prices
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · none · current-plan marking
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · none · assurance strip
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · none · paired cadence prices
...
- Archetype: stack
- Tuple: stack · vertical · one · inline · single feature quote
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · inline · card grid
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · inline · in-card feature quote
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · inline · two-row card grid
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · vertical · variable · inline · natural-height column wall
...
- Archetype: split
- Tuple: split · horizontal · variable · inline · head column beside rows
...
- Archetype: carousel
- Tuple: carousel · horizontal · variable · inline · overflow scroll rail
...
- Archetype: split
- Tuple: split · horizontal · one · left · speaker portrait
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · inline · inverted contrast band
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: stack
- Tuple: stack · vertical · one · inline · display-scale quotation
...
- Archetype: nav
- Tuple: nav · vertical · variable · inline · avatar tablist
...
- Archetype: table
- Tuple: table · vertical · variable · none · hairline rows
...
- Archetype: split
- Tuple: split · horizontal · few · inline · display lead card
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: bar
- Tuple: bar · horizontal · one · none · one-line ruled quote
...
- Archetype: overlay
- Tuple: overlay · layered · one · full-bleed · card over photo band
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · accordion rows
...
- Archetype: split
- Tuple: split · horizontal · variable · none · two-column list
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · open list
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · none · question cards
...
- Archetype: split
- Tuple: split · horizontal · variable · none · side head column
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · group-labelled sets
...
- Archetype: edge rail
- Tuple: edge rail · horizontal · variable · none · sticky jump index
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · contrast band
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · display numerals
...
- Archetype: split
- Tuple: split · horizontal · variable · left · photograph half
...
- Archetype: nav
- Tuple: nav · horizontal · variable · none · tab row
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · filter field
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · slim band
...
- Archetype: stack
- Tuple: stack · vertical · variable · none · ask panel
...
- Archetype: table
- Tuple: table · horizontal · variable · none · open ledger
...
- Archetype: stack
- Tuple: stack · vertical · one · none · huge off-ladder value
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: split
- Tuple: split · horizontal · few · none · lead/support size pair
- No-JS: No behaviour — renders as drawn without JS.

### A10-6 Split Head
- Descriptor: Head in a 416 column at the left, a 2 × 2 of stats at the right — A8·6's split holding numbers.
- Archetype: split
- Tuple: split · horizontal · few · none · head column beside stats
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: table
- Tuple: table · vertical · variable · none · ledger rows
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: stack
- Tuple: stack · vertical · few · none · proportional bars
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: split
- Tuple: split · horizontal · few · left · half-width photograph
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: article body
- Tuple: article body · vertical · few · none · in-sentence values
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · none · numbered footnote markers
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: table
- Tuple: table · vertical · few · none · full-row 96px value
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · inline · single row
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: split
- Tuple: split · horizontal · variable · right · label column
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · many · inline · wrapped rows
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · inline · surface panel
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · inline · bordered cards
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: split
- Tuple: split · horizontal · variable · right · head column
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · inline · contrast band
...
- Archetype: carousel
- Tuple: carousel · horizontal · many · full-bleed · marquee scroll
...
- Archetype: carousel
- Tuple: carousel · horizontal · many · full-bleed · reader-driven scroll
...
- Archetype: bar
- Tuple: bar · horizontal · variable · inline · typeless band
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · inline · per-logo captions
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: stack
- Tuple: stack · vertical · variable · inline · two-size tiers
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · many · inline · dense texture
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: article body
- Tuple: article body · horizontal · few · inline · marks inside sentence
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · inline · display-size title
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: stack
- Tuple: stack · vertical · variable · inline · story above roster
- No-JS: No behaviour — renders as drawn without JS.

### A12-5 Split Head
- Descriptor: Head and story in a 416 column with the people in the 824 beside it — the design for a long sub.
- Archetype: split
- Tuple: split · horizontal · variable · top · narrow head column
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · top · editorial portrait crops
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · inverted contrast band
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: split
- Tuple: split · horizontal · one · left · split biography
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · many · top · dense face wall
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: table
- Tuple: table · vertical · variable · none · hairline name ledger
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: bar
- Tuple: bar · horizontal · variable · left · overlapped face strip
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · few · top · display-size statement
- No-JS: No behaviour — renders as drawn without JS.
...
- Archetype: edge rail
- Tuple: edge rail · horizontal · many · top · reader-scrolled overflow track
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · per-card bio disclosure
...
- Archetype: grid-of-N
- Tuple: grid-of-N · horizontal · variable · top · grouped roster
- No-JS: No behaviour — renders as drawn without JS.
