...
(prds/prd-Inflozo-2026-08-17/reconcile-designs.md), read it first: it names the screens that
must move. Design artifacts are non-normative; the PRD wins on any conflict.
