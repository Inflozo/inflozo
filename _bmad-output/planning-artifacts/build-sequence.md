...
partial-success row (D2d), the tablet device preview. *Drawn on a mechanism A7 did not correct* —
Redesign Proposals (B22, ruling R-78) and Translations (B18), both on prompt A9. *States no frame
...
them as A7 corrected them in the 2026-09-04 export; the two it left (B22, B18) wait on A9. A lift is patched only with links, ids, classes, hooks
