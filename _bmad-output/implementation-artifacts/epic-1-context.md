...
- **Pinned versions are the installed versions**: Node 24, TypeScript 7.0.2 strict, Next 16.3.1, React and React DOM 19.2.8 pinned together, pnpm 11.22.0, Tailwind 4, supabase-js 2.112.3, zod 4.4.3, `gscan` 6.4.2, `handlebars` 4.7.9 dev-only and never shipped, `resend` 6.20.0, `dodopayments` 2.47.0.
