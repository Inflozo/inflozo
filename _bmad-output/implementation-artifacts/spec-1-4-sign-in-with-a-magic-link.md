...
- Supabase (real) -- `GET /auth/v1/settings` 2026-09-05: `external.email true`, `disable_signup false`, `mailer_autoconfirm false`; `passkeys_enabled false` (§20). SMTP, expiry, template and URLs are unreadable until the token exists
