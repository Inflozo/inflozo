...
import { AlertCircle, Copy } from '@/components/kit/icons'
...
/* The two list grammars of `P0-3 Item List Controls.dc.html`, which must never blur.
   ...
   THE GHOST-SOURCED CARD (:54-97) was here until Story 5.19, which replaced it with P0·5's Data group
   (`data-group.tsx`): Source, the tag or writer, the hand-picked list, Count and Order — where a customer now does
   choose which posts, by hand. FR-F1 still holds: a Ghost-bound repeat is never an item list. */
