...
import { AutoGeneratedChip } from '@/components/editor/auto-generated'
  ...
  return (
    <div className="flex h-dvh flex-col overflow-hidden bg-paper text-ink">
      <header className="relative flex h-12 shrink-0 items-center gap-[10px] border-b border-line bg-paper px-3">
        ...
        {/* D5a's centred group (:37): the switcher, and — only while this canvas is untouched — the marker chip.
            ABSOLUTELY centred, as the frame draws it, so it does not move as the project's name grows. */}
        <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center gap-2">
          <TemplateSwitcher projectId={project.id} current={key} canvases={canvases} auto={auto} empty={empty} />
          {auto.has(key) ? <AutoGeneratedChip /> : null}
        </div>
      </header>
