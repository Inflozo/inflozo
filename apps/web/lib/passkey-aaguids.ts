/**
 * AAGUID → the authenticator's own name. DATA, transcribed once and never fetched at runtime.
 *
 * Source: github.com/passkeydeveloper/passkey-authenticator-aaguids, `aaguid.json`, at commit
 * 2f1b1a0ca1e849d1a179f38c3b5cacc0e4bf6df6 (committed 2026-08-17), read 2026-09-06. The file
 * also carries a light and a dark icon per entry as base64 data URIs; NEITHER IS TRANSCRIBED —
 * the frame draws its own laptop glyph beside the row (S12 Billing.dc.html:87) and a third-party
 * logo is not a token of ours.
 *
 ...
 */
export const AAGUID_NAMES: Readonly<Record<string, string>> = {
